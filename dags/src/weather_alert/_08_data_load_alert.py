...
def send_load_success_email(is_skipped, is_failure, schema_name, table_name, batch_id, record_count):
    ...
    if is_failure == 'yes':
        ...
        status_msg = "The WEATHER Forecast pipeline has successfully processed and loaded the data."

    msg['Subject'] = f"{subject_icon} WEATHER Forecast System Notification: {status_title}"
