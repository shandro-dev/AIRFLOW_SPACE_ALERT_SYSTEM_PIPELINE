...
def send_pipeline_halted_email():
    ...
    msg['Subject'] = "CRITICAL: Weather Forecast Pipeline Execution Halted"
    ...
    <html>
        <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333; line-height: 1.6;">
            <div style="max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px; border-top: 6px solid #b91c1c;">
                ...
                <p>This is a formal notification that the <strong>Weather Forecast Pipeline</strong> has been terminated prematurely.</p>
                ...
                <p>Immediate action is required to inspect the <code>validate_data</code> task logs and rectify the data discrepancies before the next scheduled run.</p>

                <p style="margin-top: 30px;">Regards,<br><strong>Weather Forecast Automation System</strong></p>
